  ...
  <div class="row">
    ...
    <div class="col-md-4 col-xl-4 col-xxl-3" style="padding-bottom: 20px;">
      <div class="card bgi-no-repeat h-xl-100" style="height: 200px!important;background-color: #CBE9F1; background-position: 0 calc(100% + 1rem); background-size: 120% auto; background-image:url('image/portofolio-2.png')">
        <div class="card-body">
          <a href="{{ route('home') }}" class="btn btn-danger gw-bold px-6 py-3"  > Go To Home </a>
        </div>
      </div>
    </div>
        ...
        <div class="card-title d-flex flex-column">
          <div class="d-flex align-items-center">
            <span class="fs-4 fw-semibold text-gray-400 me-1 align-self-start">Rp. </span>
                <span class="fw-bolder text-dark-700 me-2 lh-1" style="font-size: 1.75rem">60.340.000.000</span>
            <span class="badge badge-light-danger fs-base">
            <i class="ki-outline ki-arrow-down fs-5 text-danger ms-n1"></i>15.3%</span>
          </div>
          <span class="text-gray-400 pt-1 fw-semibold fs-6">Total Transaksi Kemarin</span>
        </div>
      </div>
      <div class="card-body d-flex align-items-end px-0 pb-0">
        <div id="kt_card_widget_6_chart" class="w-100" style="height: 100px"></div>
      </div>
    </div>
  </div>
        ...
        <div class="card card-flush h-md-100">
          <div class="card-header pt-5">
            <div class="card-title d-flex flex-column">
              <div class="d-flex align-items-center">
                <span class="fs-4 fw-semibold text-gray-400 me-1 align-self-start">Rp. </span>
                  <span class="fw-bolder text-dark-700 me-2 lh-1" style="font-size: 1.75rem">70.140.000.000</span>
                <span class="badge badge-light-success fs-base">
                <i class="ki-outline ki-arrow-up fs-5 text-success ms-n1"></i>26.2%</span>
              </div>
              <span class="text-gray-400 pt-1 fw-semibold fs-6">Transaksi Hari Ini</span>
            </div>
          </div>
          <div class="card-body pt-2 pb-4 d-flex align-items-center">
            ...
            <div class="d-flex flex-column content-justify-center w-100">
              <div class="d-flex fs-6 fw-semibold align-items-center">
                ...
                <div class="fw-bold text-gray-600 text-xxl-end">Rp. 7.660.000</div>
              </div>
              <div class="d-flex fs-6 fw-semibold align-items-center my-3">
                <div class="bullet w-8px h-6px rounded-2 bg-primary me-3"></div>
                <div class="text-gray-500 flex-grow-1 me-4">Expense</div>
                <div class="fw-bold text-gray-600 text-xxl-end">Rp. 2.820.000</div>
              </div>
              <div class="d-flex fs-6 fw-semibold align-items-center">
                <div class="bullet w-8px h-6px rounded-2 me-3" style="background-color: #E4E6EF"></div>
                <div class="text-gray-500 flex-grow-1 me-4">Others</div>
                <div class="fw-bold text-gray-600 text-xxl-end">Rp. 4.257.000</div>
              </div>
            </div>
          </div>
        </div>
