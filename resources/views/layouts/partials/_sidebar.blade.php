<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar"
    ...
    <div id="kt_app_sidebar_wrapper" class="app-sidebar-wrapper hover-scroll-y my-5 my-lg-2" data-kt-scroll="true"
        ...
        <div id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false"
            ...
            <div class="menu-item">
                <a class="menu-link {{ request()->is(['dashboard', 'dashboard/*']) ? 'active ' : '' }}"
            ...
            <div class="menu-item">
                <a class="menu-link {{ request()->is(['hero', 'hero/*']) ? 'active ' : '' }}"
                    href="{{ route('hero') }}">
                    <span class="menu-icon">
                        <i class="fa-solid fa-user"></i>
                    </span>
                    <span class="menu-title">{{ __('Hero') }}</span>
                </a>
            </div>

            @can('skill-view')
                <div class="menu-item">
                    <a class="menu-link {{ request()->is(['skill', 'skill/*']) ? 'active ' : '' }}"
                        href="{{ route('skill.index') }}">
                        <span class="menu-icon">
                            <i class="fa-solid fa-laptop-code"></i>
                        </span>
                        <span class="menu-title">{{ __('Skills') }}</span>
                    </a>
                </div>
            @endcan
            ...
            @can('experience-view')
                <div class="menu-item">
                    <a class="menu-link {{ request()->is(['experience', 'experience/*']) ? 'active ' : '' }}"
            ...
            @can('portfolio-view')
                <div class="menu-item">
                    <a class="menu-link {{ request()->is(['portfolio', 'portfolio/*']) ? 'active ' : '' }}"
                ...
                <div data-kt-menu-trigger="click"
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        @canany(['setting-general', 'setting-smtp', 'config-view'])
                            <div data-kt-menu-trigger="click"
                                class="menu-item menu-accordion {{ request()->is(['resources/setting', 'resources/setting/*']) ? 'here show' : '' }}">
                                <span class="menu-link">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
