                        ...
                        <div class="">
                            <div class="col-lg-6">
                                <div class="mb-7">
                                    ...
                                    <div class="text-dark fw-bold">{{ $role->name }}</div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-7">
                                    <label class="required fw-semibold fs-6 mb-2">{{ __("Guard Name") }}</label>
                                    <div class="text-dark fw-bold">{{ $role->guard_name }}</div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-7">
                                    <label class="required fw-semibold fs-6 mb-2">{{ __("Total Users") }}</label>
                                    <div class="text-dark fw-bold">{{ $userCount }}</div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-7">
                                    <label class="required fw-semibold fs-6 mb-2">{{ __("List Users") }}</label>
                                    <ul>
                                        @foreach($users as $user)
                                            <li class="p-2">
                                                <a href="{{ route('resources.users.show', ['user' => $user->id]) }}">
                                                    <h6 class="card-title mb-0 text-black text"
                                                        style="text-decoration: underline;">{{ $user->name }}</h6>
                                                </a>
                                            </li>
                                        @endforeach
                                    </ul>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-7">
                                    <label class="required fw-semibold fs-6 mb-2">{{ __("List Permissions") }}</label>
                                    <ul>
