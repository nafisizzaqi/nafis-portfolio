                    ...
                    <div class="container">
                        ...
                        <div class="">
                            <div class="col-lg-6">
                                ...
                                <div class="mb-7">
                                    <label class="required fw-semibold fs-6 mb-2">{{ __("Subject") }}</label>
                                    <div class="text-dark fw-bold">{{ $contact->subject }}</div>
                                </div>

                                <div class="mb-7">
                                    <label class="required fw-semibold fs-6 mb-2">{{ __("Message") }}</label>
                                    <div class="text-dark fw-bold">{{ $contact->message }}</div>
                                </div>
                                <!--end::Name-->
                            </div>
                        </div>
