        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 flex flex-col items-center text-center">
            ...
            <div class="grid gap-8 lg:grid-cols-4">
                ...
                <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700" data-aos="fade-up" data-aos-duration="1000">
                    ...
                    <h2 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white hover:underline" data-aos="zoom-in" ><a href="#">{{ $article->title }}</a></h2>
                    <p class="mb-5 font-light text-gray-500 dark:text-gray-400" data-aos="zoom-in">{{ Str::limit($article->content, 150) }}</p>
                    <div class="flex justify-between items-center" data-aos="zoom-in" >
                        ...
                        <a href="#" class="inline-flex items-center text-sm font-medium text-primary-600 dark:text-primary-500 hover:underline hover:text-blue-500">
                            Read more
