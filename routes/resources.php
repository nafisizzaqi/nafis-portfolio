...
Route::middleware('auth')->prefix('resources')->name('resources.')->group(function () {
    ...
    // Route::resource('hero', App\Http\Controllers\Resources\HeroController::class);
    // Route::post('hero',[App\Http\Controllers\Resources\HeroController::class,'store_or_update'])->name('store.or.update');
